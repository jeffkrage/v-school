...
function myFunction (num) {   // take this function whose name is myFunction = what the function does then paraments (num) in this case is a number
                                // return to get the value out of the function. 
   return num * 2

} console.log(myFunction(4));  // myFunction now has a value of 4 and the parameter is a number and I need to return the value of the number times 2